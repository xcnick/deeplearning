...
LOAD_WEIGHTS_MAPS = {
    ...
    "pd": {"bert": {"tf": load_tf_weights_in_bert, "hf": load_huggingface_weights_in_bert}},
}
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        choices=("tf", "pt", "ms", "of", "pd"),
        help="To model : tensorflow / pytorch / mindspore / oneflow / paddle",
    )
    parser.add_argument(
