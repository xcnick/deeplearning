...
data = dict(
    ...
    train=dict(type=dataset_type, filenames=[
        data_root + "train.tfrecord",
    ]),
    val=dict(type=dataset_type, filenames=[
        data_root + "val.tfrecord",
    ]),
)
...
train_pipeline = [
    ...
    dict(type="Map", transforms=[
        dict(type="THUCNewsTFRecordParser"),
    ]),
