...
if is_torch_available():
    ...
    def build_torch_models(cfg, default_args=None):
        return build_from_cfg(
            cfg, registry=PT_MODELS, default_args=default_args)
...
if is_tf_available():
    ...
    def build_tf_pipelines(cfg, default_args=None):
        return build_from_cfg(
            cfg, registry=TF_PIPELINES, default_args=default_args)

    def build_tf_transforms(cfg, default_args=None):
        return build_from_cfg(
            cfg, registry=TF_TRANSFORMS, default_args=default_args)

    def build_tf_models(cfg, default_args=None):
        return build_from_cfg(
            cfg, registry=TF_MODELS, default_args=default_args)

    def build_tf_callbacks(cfg, default_args=None):
        return build_from_cfg(
            cfg, registry=TF_CALLBACKS, default_args=default_args)
    ...
    def register_tf_optimizers():
        ...
        for module_name in dir(tf.keras.optimizers):
            ...
            if inspect.isclass(_optim) and issubclass(
                    _optim, tf.keras.optimizers.Optimizer):
    ...
    def build_tf_optimizers(cfg, default_args=None):
        ...
        return build_from_cfg(
            cfg, registry=TF_OPTIMIZERS, default_args=default_args)
...
if is_ms_available():
    ...
    def build_ms_models(cfg, default_args=None):
        return build_from_cfg(
            cfg, registry=MS_MODELS, default_args=default_args)
...
if is_of_available():
    ...
    def build_of_models(cfg, default_args=None):
        return build_from_cfg(
            cfg, registry=OF_MODELS, default_args=default_args)
...
if is_paddle_available():
    ...
    def build_pd_models(cfg, default_args=None):
        return build_from_cfg(
            cfg, registry=PD_MODELS, default_args=default_args)
